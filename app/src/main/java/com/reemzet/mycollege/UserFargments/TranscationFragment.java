...
import com.reemzet.mycollege.Sbte.Models.PdfModel;
import com.reemzet.mycollege.ViewHolder.TranscationViewHolder;
        ...
        adapter=new FirebaseRecyclerAdapter<TranscationModel, TranscationViewHolder>(options) {
           ...
           shimmerFrameLayout.stopShimmer();
                 ...
                 if (model.getTrantype().equals("Debit")){
                    ...
                    holder.tvtrandate.setText(model.getTrandate());
