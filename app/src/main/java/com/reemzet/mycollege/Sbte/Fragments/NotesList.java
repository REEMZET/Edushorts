...
public class NotesList extends Fragment {
    ...
    DatabaseReference librarypdfref, admintransref, userref;
    String folderref;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        librarypdfref = database.getReference("MyCollege/Sbte/Learning").child(folderref);
        ...
        recyclerView = view.findViewById(R.id.noteslistrecycler);
    ...
    public void setRecyclerView() {
        ...
        adapter = new FirebaseRecyclerAdapter<ItemModels, PdfListViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull PdfListViewHolder holder, int position, @NonNull ItemModels model) {
                ...
                if (new File(folder.getAbsoluteFile(), "Notes-" + model.getItemtitle()).exists()) {
                    ...
                    public void onClick(View v) {
                        if (holder.tvitemprice.getText().equals("free") || holder.tvitemprice.getText().equals("purchased")) {
                            if (new File(folder.getAbsoluteFile(), "Notes-" + model.getItemtitle()).exists()) {
                                new AlertDialog.Builder(getActivity())
                                        ...
                                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                File file = (new File(folder.getAbsoluteFile(), "Notes-" + model.getItemtitle()));
                                                file.delete();
                                ...
                                downloadNotes(model.getItemurl(), folder.getAbsolutePath(), "Notes-" + model.getItemtitle());
                            }
                        } else {
                    ...
                    public void onClick(View view) {
                        if (holder.tvitemprice.getText().equals("free") || holder.tvitemprice.getText().equals("purchased")) {
                            ...
                            if (new File(folder.getAbsoluteFile(), "Notes-" + model.getItemtitle()).exists()) {
                                ...
                                bundle.putString("file", "Notes-" +model.getItemtitle());
                                    ...
                                    userref.child("amount").setValue(String.valueOf(remainbalance)).addOnSuccessListener(
                                            new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    ...
                                                    TranscationModel transcationModel = new TranscationModel("Purchase Notes", "Debit", model.getItemprice(), model.getItemid(), (String) s, currentTime, mAuth.getUid());
                ...
                .start(new OnDownloadListener() {
                    ...
                    public void onDownloadComplete() {
                        ...
                        if (NotesList.this.isVisible()) {
                            ...
                            navController.navigate(R.id.action_notesList_to_pdfViewer, bundle);
                        }
