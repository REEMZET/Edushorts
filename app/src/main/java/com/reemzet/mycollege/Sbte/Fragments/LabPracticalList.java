...
public class LabPracticalList extends Fragment {
    ...
    DatabaseReference librarypdfref, userref, admintransref;
    String streamkey;
                                    ...
                                    userref.child("amount").setValue(String.valueOf(remainbalance)).addOnSuccessListener(
                                            new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    ...
                                                    TranscationModel transcationModel = new TranscationModel("Purchase lab", "Debit", model.getItemprice(), model.getItemid(), (String) s, currentTime, mAuth.getUid());
