...
import com.reemzet.adminedushorts.Sbte.Adapter.LearningPosterAdapter;
import com.reemzet.adminedushorts.Sbte.Model.LearningposterModel;
import com.reemzet.adminedushorts.Sbte.Model.VideoModel;
import com.reemzet.adminedushorts.Sbte.ViewHolder.VideoViewHolder;
...
public class Learning extends Fragment {
    ...
    String streamkey;
    Toolbar toolbar;
    LinearLayout linearvideos,noteslayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearvideos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                navController.navigate(R.id.action_learning2_to_folders,bundle);
            }
        });
