...
public class PdfModel {
    ...
    public PdfModel(String itemtitle, String itemurl, String itemdesc, String itemlength, String itemprice, String itemid, String itemtype, String uploaddate, String itemviewcount, String itemthumbnail) {
    ...
    public PdfModel(String itemtitle, String itemurl, String itemdesc, String itemlength, String itemprice, String itemid, String itemtype, String uploaddate, String itemviewcount, String itemthumbnail, List<String> itemtag) {
        this.itemtitle = itemtitle;
        this.itemurl = itemurl;
        this.itemdesc = itemdesc;
        this.itemlength = itemlength;
